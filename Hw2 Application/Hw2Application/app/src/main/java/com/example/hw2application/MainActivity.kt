                ...
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = "frontPage") {
                        ...
                        composable("detailPage/{attractionId}") { backStackEntry ->
                            val attractionIdString =
                                backStackEntry.arguments?.getString("attractionId")
                            val attractionId = attractionIdString?.toInt()
...
fun DetailPageScreen(attractionId: Int, navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Button(//地圖按鈕
            onClick = {
                val gmmIntentUri = Uri.parse("geo:${attraction.latitude},${attraction.longitude}")
...
//        ) , navController = navController )
        ...
        //DetailPageScreen(2,navController)
    }
}
